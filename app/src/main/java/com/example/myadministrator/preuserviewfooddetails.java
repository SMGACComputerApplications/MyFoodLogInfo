...
public class preuserviewfooddetails extends AppCompatActivity {
...
AlertDialog.Builder builder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent in = new Intent(preuserviewfooddetails.this, DayHolder.class);
                        ...
                        builder.setMessage("You Do to Healthy Eating!! View Caloric Percentage")
                                ...
                                .setPositiveButton("View", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        finish();
                                        startActivity(new Intent(preuserviewfooddetails.this, finalanswerdisplay.class));
                                ...
                                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.cancel();
                                        startActivity(new Intent(preuserviewfooddetails.this, preuserviewfooddetails.class));
        ...
        ProductsRef.child("Energy").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                useradapter=new SelectionFoodView(preuserviewfooddetails.this,list);

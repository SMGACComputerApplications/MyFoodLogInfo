...
public class selectingFoodview {
    String carbocall,energycall,fatcall,fibrecall,foodimage,netcall,proteincall,quantity,recipename,sizeof;

    public selectingFoodview() {
    }

    public selectingFoodview(String carbocall, String energycall, String fatcall, String fibrecall, String foodimage, String netcall, String proteincall, String quantity, String recipename, String sizeof) {

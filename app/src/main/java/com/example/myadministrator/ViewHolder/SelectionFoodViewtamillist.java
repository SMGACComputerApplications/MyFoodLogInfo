...
public class SelectionFoodViewtamillist extends RecyclerView.Adapter<SelectionFoodViewtamillist.MyUserViewHolder>{
...
public static int cartcount=0;
    public SelectionFoodViewtamillist(Context context, ArrayList<separatecalculation> userfoodrecipes) {
...
mainfoodadd=FirebaseDatabase.getInstance().getReference().child("Users").child(userid);
        ...
        holder.c1.setText(" மாவுச்சத்து: "+userfoodrecipes.get(position).getCarbo());
        holder.pr1.setText("புரதம்: "+userfoodrecipes.get(position).getProtein());

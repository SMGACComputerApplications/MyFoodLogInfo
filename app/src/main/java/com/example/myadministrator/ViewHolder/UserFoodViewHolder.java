...
import com.example.myadministrator.Main2Activity;
import com.example.myadministrator.MainHome;
...
import com.example.myadministrator.waisthip;
...
public class UserFoodViewHolder extends RecyclerView.Adapter<UserFoodViewHolder.MyUserViewHolder> implements Filterable {
...
public static int cartcount=0;
    public UserFoodViewHolder(Activity a,Context context, ArrayList<UserFoodList> userfoodrecipes, QuantityChangeListener mQcl) {
        ...
        holder.plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               b=a.replaceAll("\\s+","");
                ...
                food.put("sizeof",(userfoodrecipes.get(position).getQuantity())+(userfoodrecipes.get(position).getQuantitysizeno()));

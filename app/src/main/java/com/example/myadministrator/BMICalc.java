...
public class BMICalc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bmicalc.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
        ...
        private void womenbmi(){
            ...
            if((TextUtils.isEmpty(weight))&&(TextUtils.isEmpty(height))&&(TextUtils.isEmpty(uage))){
                Toast.makeText(this, "Please Enter following Details ..", Toast.LENGTH_SHORT).show();
            ...
            UserRef.updateChildren(bmivalue).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    if (task.isSuccessful()) {
                        loadingBar.dismiss();
                        Toast.makeText(BMICalc.this, "BMI Value is added successfully..", Toast.LENGTH_SHORT).show();
                    ...
                    else
                    {
                        ...
                        Toast.makeText(BMICalc.this, "Error: " + message, Toast.LENGTH_LONG).show();
                    }
